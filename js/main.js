...
import {
  openProjectModal, openTaskModal, openProfileEditModal, openMembersModal, closeModal,
} from './ui.js';
import {
...
function enterApp() {
  ...
  if (State.currentUser) {
    ...
    if (accepted > 0) {
      toast(`Вы добавлены в ${accepted} ${accepted === 1 ? 'проект' : 'проект(а/ов)'} по приглашению`, 'success');
    }
  }
