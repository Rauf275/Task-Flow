...
export function showView(viewName) {
  ...
  // Календарь мог быть открыт давно (вкладка не перезагружалась днями),
  // и State.calendarCursor мог "застрять" на старом месяце. При каждом
  // заходе на вкладку календаря синхронизируем курсор с реальным "сегодня",
  // иначе сегодняшние задачи/дедлайны просто не попадают в отображаемый месяц.
