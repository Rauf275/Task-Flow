...
const KEYS = {
  ...
  invitations: 'taskflow_invitations',
};
...
export const Storage = {
  ...
  // ---- Invitations ----
  // Приглашения в проект. До подключения backend "отправка письма"
  // симулируется: если приглашённый email уже зарегистрирован,
  // пользователь добавляется в проект сразу; иначе приглашение
  // остаётся "pending" и применяется при следующей регистрации/входе
  // с этим email (см. invitations.js).
  getInvitations() { return read(KEYS.invitations, []); },
  setInvitations(list) { return write(KEYS.invitations, list); },
